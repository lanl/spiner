...
class Build(BuildEnvironment):
    ...
    spack_env = environment("spiner_default")
    project_spec = environment("spiner+test")
    ...
    def ci_message(self, args):
        ...
        if "PORTS_OF_CALL_MR" in self.environ and self.environ["PORTS_OF_CALL_MR"]:
            pre_alloc_init += f"export PORTS_OF_CALL_MR={self.environ['PORTS_OF_CALL_MR']}\n"
    ...
    def env(self, args):
        ...
        # Always allow lockfile changes since we clone ports-of-call@main
        ...
        # Handle ports-of-call development dependency
        ports_of_call_path = self.source_dir / "extern" / "ports-of-call"
